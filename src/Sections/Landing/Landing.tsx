		...
		<MainDiv>
			<ContainerStyled>
				<ContentWrapper>
					...
					<SubHeading className="sub-hero">
						Software Engineer
					</SubHeading>
					<Heading className="sub-hero">
						@ Turners Automotive Group
					</Heading>
					<p className="content">
						I thrive on collaboration and teamwork, having gained
						valuable industry experience in both small and large
						software teams. In addition, my ability to quickly pick
						up new technologies and diving deep into investigations
						sets me apart.
					</p>
					<p className="content">
						I’m passionate about frontend development, user
						experience-driven design, and creating seamless
						interfaces. However, I’m equally comfortable working on
						the server side of applications — I embrace full stack
						roles. As long as the work is challenging and offers
					...
					<OfferButton
						...
						onClick={() => {
							document
								.getElementById("scrollTriggerServices")
								?.scrollIntoView({
									behavior: "smooth",
								});
						}}
